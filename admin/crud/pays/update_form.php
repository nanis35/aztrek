...
<form action="update_query.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="description" value="<?php echo $pays["description"]; ?>" class="form-control" placeholder="Descrition">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="file" name="photo" value="<?php echo $pays["photo"]; ?>" class="form-control" placeholder="Photo">
        </div>
    </div>
